...
//Below we can define functions

godot_variant shmem_get_data(godot_object *p_instance, void *p_method_data,
        void *p_user_data, int p_num_args, godot_variant **p_args);

//GDNative initialization code. You can ignore this for the most part
...
/**
 * From here on is code that is actually relevant to reading the shmem
 * instead of interfacing with the godot enginer
*/
